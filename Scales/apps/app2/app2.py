...
icon_path = "D:\\Python\\Application\\app2\\logo.ico"  # Абсолютный путь к вашей иконке .ico файла 
...
#pyinstaller --windowed --icon=D:\\Python\\Application\\app2\\logo.ico app2.py
#pyinstaller --onefile --windowed --icon=D:\\Python\\Application\\app2\\logo.ico app2.py
