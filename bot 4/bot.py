...
async def process_phone(message: types.Message, state: FSMContext):
    ...
    async with aiosqlite.connect('users.db') as db:
        ...
        async with aiohttp.ClientSession() as session:
            url = 'https://script.google.com/macros/s/AKfycbxM5ECn9Xn37DVX7hqEeSsauNcvM5j99gycswDy9jJ7T5N_m0VzO7nDScoIIam5ofAp/exec'  # Замените на URL вашего веб-приложения
